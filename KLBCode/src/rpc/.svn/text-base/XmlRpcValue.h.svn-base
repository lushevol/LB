...
namespace XmlRpc {
    ...
    class XmlRpcValue {
        public:
            ...
            const ValueStruct& getStruct() const {
                assertTypeOrInvalid(TypeStruct);
                return *_value.asStruct;
            }
            ValueStruct& getStruct() {
                assertTypeOrInvalid(TypeStruct);
                return *_value.asStruct;
            }
            ...
            void setSize(int size)    {
                assertTypeOrInvalid(TypeArray);
                _value.asArray->resize(size);  /*assertArray(size);*/
            }
            ...
            bool fromXml(std::string const& valueXml);
            bool fromXml(TiXmlElement* value);
        ...
        protected:
            ...
            // XML decoding
            bool boolFromXml(const char* value);
            bool intFromXml(const char* value);
            bool doubleFromXml(const char* value);
            bool stringFromXml(const char* value);
            bool timeFromXml(const char* value);
            bool binaryFromXml(const char* value);
            bool arrayFromXml(TiXmlElement* value);
            bool structFromXml(TiXmlElement* value);
