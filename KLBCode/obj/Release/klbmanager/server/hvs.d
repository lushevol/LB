obj/Release/klbmanager/server/hvs.o obj/Release/klbmanager/server/hvs.d: src/server/hvs.cpp src/server/share/include.h \
 ...
 src/server/model/interface.h src/server/bonding.h src/server/ha.h
	rm -f obj/Release/klbmanager/server/hvs.d
	make -f make.do obj/Release/klbmanager/server/hvs.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/hvs.o src/server/hvs.cpp
%.h: fail
