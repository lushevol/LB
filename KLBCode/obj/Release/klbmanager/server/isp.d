obj/Release/klbmanager/server/isp.o obj/Release/klbmanager/server/isp.d: src/server/isp.cpp src/server/share/utility.h src/server/rpc.h \
 ...
 src/server/model/isp.h
	rm -f obj/Release/klbmanager/server/isp.d
	make -f make.do obj/Release/klbmanager/server/isp.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/isp.o src/server/isp.cpp
%.h: fail
