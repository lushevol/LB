obj/Release/klbmanager/server/bonding.o obj/Release/klbmanager/server/bonding.d: src/server/bonding.cpp src/server/share/utility.h \
 ...
 src/server/ethernet.h
	rm -f obj/Release/klbmanager/server/bonding.d
	make -f make.do obj/Release/klbmanager/server/bonding.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/bonding.o src/server/bonding.cpp
%.h: fail
