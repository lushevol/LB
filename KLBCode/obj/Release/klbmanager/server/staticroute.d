obj/Release/klbmanager/server/staticroute.o obj/Release/klbmanager/server/staticroute.d: src/server/staticroute.cpp src/server/share/include.h \
 ...
 src/server/model/isp.h
	rm -f obj/Release/klbmanager/server/staticroute.d
	make -f make.do obj/Release/klbmanager/server/staticroute.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/staticroute.o src/server/staticroute.cpp
%.h: fail
