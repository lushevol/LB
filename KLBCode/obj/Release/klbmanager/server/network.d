obj/Release/klbmanager/server/network.o obj/Release/klbmanager/server/network.d: src/server/network.cpp src/server/share/include.h \
 src/server/share/utility.h src/server/model/network.h \
 ...
 src/server/ha.h src/server/model/ipvs.h
	rm -f obj/Release/klbmanager/server/network.d
	make -f make.do obj/Release/klbmanager/server/network.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/network.o src/server/network.cpp
%.h: fail
