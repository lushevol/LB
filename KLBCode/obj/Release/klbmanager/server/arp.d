obj/Release/klbmanager/server/arp.o obj/Release/klbmanager/server/arp.d: src/server/arp.cpp src/server/share/utility.h \
 ...
 src/server/network.h
	rm -f obj/Release/klbmanager/server/arp.d
	make -f make.do obj/Release/klbmanager/server/arp.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/arp.o src/server/arp.cpp
%.h: fail
