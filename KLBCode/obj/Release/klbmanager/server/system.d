obj/Release/klbmanager/server/system.o obj/Release/klbmanager/server/system.d: src/server/system.cpp src/server/share/utility.h \
 ...
 src/server/model/system.h src/server/model/types.h src/server/system.h
	rm -f obj/Release/klbmanager/server/system.d
	make -f make.do obj/Release/klbmanager/server/system.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/system.o src/server/system.cpp
%.h: fail
