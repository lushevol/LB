obj/Release/klbmanager/server/recorder.o obj/Release/klbmanager/server/recorder.d: src/server/recorder.cpp src/server/share/utility.h \
 ...
 src/server/share/include.h
	rm -f obj/Release/klbmanager/server/recorder.d
	make -f make.do obj/Release/klbmanager/server/recorder.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/recorder.o src/server/recorder.cpp
%.h: fail
