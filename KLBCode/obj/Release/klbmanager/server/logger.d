obj/Release/klbmanager/server/logger.o obj/Release/klbmanager/server/logger.d: src/server/logger.cpp src/server/share/utility.h \
 ...
 src/server/logger.h src/server/model/types.h
	rm -f obj/Release/klbmanager/server/logger.d
	make -f make.do obj/Release/klbmanager/server/logger.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/logger.o src/server/logger.cpp
%.h: fail
