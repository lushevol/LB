obj/Release/klbmanager/server/ha.o obj/Release/klbmanager/server/ha.d: src/server/ha.cpp src/server/share/utility.h src/server/rpc.h \
 ...
 src/server/model/hvs.h src/server/model/ipvs.h
	rm -f obj/Release/klbmanager/server/ha.d
	make -f make.do obj/Release/klbmanager/server/ha.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -O3  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__RELEASE__ -DNDEBUG -c -o obj/Release/klbmanager/server/ha.o src/server/ha.cpp
%.h: fail
