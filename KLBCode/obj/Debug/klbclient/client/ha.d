obj/Debug/klbclient/client/ha.o obj/Debug/klbclient/client/ha.d: src/client/ha.cpp src/client/model/ipvs.h src/client/model/model.h \
 ...
 src/client/control.h src/client/model/model.h src/client/parser.h
	rm -f obj/Debug/klbclient/client/ha.d
	make -f make.do obj/Debug/klbclient/client/ha.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__ -c -o obj/Debug/klbclient/client/ha.o src/client/ha.cpp
%.h: fail
