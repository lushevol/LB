obj/Debug/klbclient/client/blacklist.o obj/Debug/klbclient/client/blacklist.d: src/client/blacklist.cpp src/client/model/blacklist.h \
 ...
 src/client/control.h src/client/parser.h
	rm -f obj/Debug/klbclient/client/blacklist.d
	make -f make.do obj/Debug/klbclient/client/blacklist.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__ -c -o obj/Debug/klbclient/client/blacklist.o src/client/blacklist.cpp
%.h: fail
