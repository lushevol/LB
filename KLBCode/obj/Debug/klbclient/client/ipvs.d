obj/Debug/klbclient/client/ipvs.o obj/Debug/klbclient/client/ipvs.d: src/client/ipvs.cpp src/client/model/ipvs.h \
 ...
 src/client/tools.h
	rm -f obj/Debug/klbclient/client/ipvs.d
	make -f make.do obj/Debug/klbclient/client/ipvs.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__ -c -o obj/Debug/klbclient/client/ipvs.o src/client/ipvs.cpp
%.h: fail
