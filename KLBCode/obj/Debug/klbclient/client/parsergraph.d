obj/Debug/klbclient/client/parsergraph.o obj/Debug/klbclient/client/parsergraph.d: src/client/parsergraph.cpp src/client/model/interface.h \
 ...
 src/client/parser.h
	rm -f obj/Debug/klbclient/client/parsergraph.d
	make -f make.do obj/Debug/klbclient/client/parsergraph.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__ -c -o obj/Debug/klbclient/client/parsergraph.o src/client/parsergraph.cpp
%.h: fail
