obj/Debug/klbclient/client/bind.o obj/Debug/klbclient/client/bind.d: src/client/bind.cpp src/client/model/bind.h \
 ...
 src/client/model/model.h src/client/parser.h
	rm -f obj/Debug/klbclient/client/bind.d
	make -f make.do obj/Debug/klbclient/client/bind.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__CLIENT__ -D__DEBUG__ -c -o obj/Debug/klbclient/client/bind.o src/client/bind.cpp
%.h: fail
