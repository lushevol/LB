obj/Debug/klbmanager/server/services.o obj/Debug/klbmanager/server/services.d: src/server/services.cpp src/server/share/include.h \
 ...
 src/server/model/interface.h src/server/bonding.h src/server/recorder.h
	rm -f obj/Debug/klbmanager/server/services.d
	make -f make.do obj/Debug/klbmanager/server/services.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__ -c -o obj/Debug/klbmanager/server/services.o src/server/services.cpp
%.h: fail
