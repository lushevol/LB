obj/Debug/klbmanager/server/nat.o obj/Debug/klbmanager/server/nat.d: src/server/nat.cpp src/server/share/include.h \
 src/server/share/debug.h src/server/share/utility.h \
 src/server/share/include.h src/server/model/interface.h \
 ...
 src/server/ethernet.h src/server/interface.h src/server/bonding.h
	rm -f obj/Debug/klbmanager/server/nat.d
	make -f make.do obj/Debug/klbmanager/server/nat.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__ -c -o obj/Debug/klbmanager/server/nat.o src/server/nat.cpp
%.h: fail
