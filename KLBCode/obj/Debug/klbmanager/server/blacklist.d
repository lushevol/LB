obj/Debug/klbmanager/server/blacklist.o obj/Debug/klbmanager/server/blacklist.d: src/server/blacklist.cpp src/server/share/include.h \
 ...
 src/server/blacklist.h src/server/model/blacklist.h
	rm -f obj/Debug/klbmanager/server/blacklist.d
	make -f make.do obj/Debug/klbmanager/server/blacklist.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__ -c -o obj/Debug/klbmanager/server/blacklist.o src/server/blacklist.cpp
%.h: fail
