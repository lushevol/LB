obj/Debug/klbmanager/server/policyroute.o obj/Debug/klbmanager/server/policyroute.d: src/server/policyroute.cpp src/server/share/utility.h \
 ...
 src/server/model/isp.h src/server/network.h
	rm -f obj/Debug/klbmanager/server/policyroute.d
	make -f make.do obj/Debug/klbmanager/server/policyroute.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__ -c -o obj/Debug/klbmanager/server/policyroute.o src/server/policyroute.cpp
%.h: fail
