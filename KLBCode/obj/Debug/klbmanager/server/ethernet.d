obj/Debug/klbmanager/server/ethernet.o obj/Debug/klbmanager/server/ethernet.d: src/server/ethernet.cpp src/server/share/utility.h \
 ...
 src/server/interface.h src/server/model/interface.h
	rm -f obj/Debug/klbmanager/server/ethernet.d
	make -f make.do obj/Debug/klbmanager/server/ethernet.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__ -c -o obj/Debug/klbmanager/server/ethernet.o src/server/ethernet.cpp
%.h: fail
