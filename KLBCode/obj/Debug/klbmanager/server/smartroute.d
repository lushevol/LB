obj/Debug/klbmanager/server/smartroute.o obj/Debug/klbmanager/server/smartroute.d: src/server/smartroute.cpp src/server/share/utility.h \
 ...
 src/server/model/route.h src/server/model/isp.h
	rm -f obj/Debug/klbmanager/server/smartroute.d
	make -f make.do obj/Debug/klbmanager/server/smartroute.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__ -c -o obj/Debug/klbmanager/server/smartroute.o src/server/smartroute.cpp
%.h: fail
