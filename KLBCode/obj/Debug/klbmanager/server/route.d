obj/Debug/klbmanager/server/route.o obj/Debug/klbmanager/server/route.d: src/server/route.cpp src/server/share/include.h \
 src/server/share/debug.h src/server/share/utility.h \
 src/server/share/include.h src/server/base.h src/server/model/model.h \
 ...
 src/server/model/interface.h
	rm -f obj/Debug/klbmanager/server/route.d
	make -f make.do obj/Debug/klbmanager/server/route.d -e CC:='g++' CPPFLAGS:='-Wall -fexceptions -I/usr/src/linux/include -fpermissive -g' INCLUDES:='' DEFINE:='-DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__'
	g++ -Wall -fexceptions -I/usr/src/linux/include -fpermissive -g  -DTIXML_USE_STL -D__EXPORTED_HEADERS__ -D__SERVER__ -D__DEBUG__ -c -o obj/Debug/klbmanager/server/route.o src/server/route.cpp
%.h: fail
