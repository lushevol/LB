...
<script src="${ctx}/js/kylin.klb.statistics.server.js" charset="utf-8"></script>
<script src="${ctx}/js/kylin.statistics.initServer.js" charset="utf-8"></script>
...
<body>
	<form name="ServerForm" id="ServerForm"
		action="klb-statistics-server!export.action" onsubmit="return false">
		<!--面板开始-->
		...
		<div class="mainPartContNoTop">
			...
			<div class="quickSearch">
				<table cellspacing="0">
					<tr>
						<th width="73">真实服务器：</th>
						<td>
							<select id="server" name="server">
								<option value="">全部</option>
								<c:forEach var="serv" items="${serverce}">
			...
			<!--曲线图开始 -->
			<div class="graph">
				<h3 class="graphTit">服务器转发统计曲线图</h3>
				<p class="graphBtn">
